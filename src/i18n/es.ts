export default {
  header: {
    ...
    services: [
      {
        label: "Construcción Piscinas",
        href: "/es/services/pool-construction",
      },
      {
        label: "Remodelación Concreto",
        href: "/es/services/concrete-remodeling",
      },
      {
        label: "Suministro Hormigón",
        href: "/es/services/concrete-supply",
      },
      {
        label: "Proyectos Intregales",
  ...
  main: {
      ...
      second: [
        {
          ...
          description: "Programación eficiente para cada proyecto.",
        },
        {
          title: "Flota moderna",
        ...
        },
        {
          ...
          description: "Precisión en cada vertido.",
        },
        {
          title: "Resultados comprobados",
          description: "Soluciones de concreto que perduran.",
        },
      ],
      third: {
        title:
          "<span class='text-secondary'>Excelencia en concreto</span> para cada proyecto",
        para1:
          "Ofrecemos soluciones de concreto confiables, respaldadas por experiencia y calidad comprobada",
        para2:
        ...
        items: [
          ...
          },
          {
            ...
            description: "Diseñado para perdurar.",
          },
          {
            title: "Calidad garantizada",
            description: "Precisión en cada detalle.",
          },
          {
            title: "Planificación estratégica",
            description: "Eficiencia de inicio a fin.",
          },
        ],
      },
    },
    services: {
      ...
      description:
        "Soluciones integrales en concreto diseñadas para ofrecer <br/> resistencia, durabilidad y precisión en cada proyecto.",
      button: {
      ...
      items: [
        {
          ...
          description: "Piscinas personalizadas diseñadas para durar.",
          button: {
            label: "Más Información",
            href: "/pool-construction",
          },
          first: "Construcción de Piscinas",
        },
        {
          ...
          first: "Remodelaciones en Concreto",
        },
        {
          title: "Suministro de Concreto",
          description: "Concreto confiable, entregado a tiempo.",
          button: {
            label: "Más Información",
            href: "/concrete-supply",
          },
          first: "Suministro de Concreto",
        },
        {
          title: "Proyectos Integrales",
          description:
            "Soluciones completas para una ejecución sin complicaciones.",
          button: {
            label: "Más Información",
            href: "/turnkey-projects",
          },
          first: "Proyectos Integrales",
        },
        {
          title: "MEDO & Sucursales Virtuales",
          description: "Expande tu negocio con nuestro sistema probado.",
          button: {
            label: "Más Información",
            href: "/medo",
          },
          first: "MEDO & Sucursales Virtuales",
        },
        {
          title: "Alquiler de equipos y patios",
          description: "Equipos y espacios para impulsar tus proyectos.",
          button: {
            label: "Más Información",
            href: "/rental-equipment",
          },
          first: "Alquiler de equipos y patios",
        },
      ],
    },
    projects: {
    ...
    callAction: {
      title:
        "donde comienzan los <br class='hidden lg:block'/> proyectos sólidos",
    },
  },
  about: {
    hero: {
    ...
    who: {
      title: "¿Quiénes somos?",
      subtitle:
        "Somos una empresa integral dedicada a satisfacer múltiples necesidades en el campo de la construcción.",
      description:
  ...
  servicesPage: {
    ...
    items: [
      ...
      {
        title: "REMODELACIÓN DE concreto",
        subtitle:
          "Transformamos espacios exteriores con soluciones de  <br class='hidden md:block lg:hidden xl:block'/> hormigón  de alta calidad: patios, entradas de vehículos, senderos, ampliaciones.",
        description:
          "Creamos áreas funcionales y duraderas con un alto impacto visual.",
        image: "services-2",
        button: {
          label: "Más Información",
          href: "/es/services/concrete-remodeling",
      ...
      {
        title: "SUMINISTRO DE HORMIGÓN",
        subtitle:
          "Ofrecemos hormigón premezclado para proyectos <br class='hidden md:block lg:hidden xl:block'/> residenciales y comerciales, con logística eficiente y <br class='hidden md:block lg:hidden xl:block'/> entrega a tiempo.",
        description:
          "Ideal para: contratistas, constructores, proyectos independientes.",
        image: "services-3",
        button: {
          label: "Más Información",
          href: "/es/services/concrete-supply",
      ...
      },
      {
        title: "Proyectos Integrales",
        subtitle:
          "Gestionar múltiples proveedores puede generar <br class='hidden md:block lg:hidden xl:block'/> retrasos, sobrecostos y problemas de coordinación.",
        description:
          "Nuestro enfoque integral centraliza cada etapa del <br class='hidden md:block lg:hidden xl:block'/> proyecto bajo una sola gestión.",
        image: "services-4",
        button: {
          label: "Más Información",
          href: "/es/services/turnkey-projects",
      ...
      },
      {
        title: "MEDO & Sucursales Virtuales",
        subtitle:
          "Forma parte de nuestro ecosistema empresarial y <br class='hidden md:block lg:hidden xl:block'/> genera ingresos en la industria de la construcción sin <br class='hidden md:block lg:hidden xl:block'/> empezar desde cero.",
        description:
          ". Opera tu propio camión (MEDO) <br/> . Abre tu propia sucursal <br/> . Accede a nuestra red y sistema operativo",
        image: "services-5",
        button: {
          label: "Más Información",
          href: "/es/services/medo",
      ...
      },
      {
        title: "Alquiler de equipos y patios",
        subtitle:
          "Contar con los equipos y espacios adecuados puede marcar <br class='hidden md:block lg:hidden xl:block'/> la diferencia en la productividad de cualquier proyecto.",
        description:
          "Ofrecemos soluciones flexibles para apoyar operaciones <br class='hidden md:block lg:hidden xl:block'/> de construcción, almacenamiento y logística.",
        image: "services-6",
        button: {
          label: "Más Información",
          href: "/es/services/rental-equipment",
  ...
  footer: {
    ...
    services: {
      ...
      links: [
        {
          label: "Construcción de Piscinas",
          href: "es/services/pool-construction",
        },
        {
          label: "Remodelaciones en Concreto",
          href: "es/services/concrete-remodeling",
        },
        {
          label: "Suministro de Concreto",
          href: "es/services/concrete-supply",
        },
        {
        ...
        {
          label: "Alquiler de equipos y patios",
          href: "es/services/rental-equipment",
        },
      ],
    },
    servicesArea: {
      ...
      description:
        "Brindamos nuestros servicios en Carolina del Norte y Carolina del Sur, incluyendo:",
